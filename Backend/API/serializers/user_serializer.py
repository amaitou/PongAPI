...
class RegistrationSerializer(serializers.ModelSerializer):
    ...
    """
    Serializer for user registration. It validates the password and confirms that the passwords match.
    If no avatar is provided, it assigns one based on the gender.
    """
    ...
    def validate(self, data):
        ...
        """
        Validates that the password and re-password match.
        """
        if 'password' in data:
            if not 're_password' in data or ('re_password' in data and data['password'] != data['re_password']):
    ...
    def create(self, validated_data):
        ...
        """
        Creates a new user with the provided data and sets the password.
        If no avatar is provided, it sets the default avatar based on gender.
        """
...
class ProfileUpdatingSerializer(serializers.ModelSerializer):
    ...
    Validates the uniqueness of email and username.
    """
    ...
    def validate_username(self, value):
        ...
        """
        Validates that the username is not already in use by another user.
        """
    ...
    def validate_two_fa(self, value):
        ...
        """
        Validates that the two-factor authentication (2FA) value is either True or False.
        """
...
class FriendOperationsSerializer(serializers.ModelSerializer):
    ...
    """
    Serializer for performing friend-related operations such as sending, accepting, declining, and unfriending.
    It validates the request status and ensures the operations are valid.
    """
    ...
    def validate_request_status(self, value):
        ...
        """
        Validates that the request status is one of the allowed values: 'P', 'A', 'D', 'U'.
        """
    ...
    def validate(self, attrs):
        ...
        """
        Validates that the sender cannot send a friend request to themselves.
        """
    ...
    def create(self, validated_data):
        ...
        """
        Creates a new friend request or updates the friendship based on the request status.
        Handles pending (P), accepted (A), declined (D), and unfriended (U) operations.
        """
...
class GetBasicUserInfoSerializer(serializers.ModelSerializer):
    ...
    """
    Serializer for retrieving basic user information along with their game statistics.
    """
    ...
    class Meta:
        model = UserInfo
        fields = ['id', 'username', 'first_name', 'last_name', 'email', 'avatar', 'gender', 'game_stats']

class GetFriendshipListSerializer(serializers.ModelSerializer):

    """
    Serializer for retrieving a user's friend list.
    """
...
class GetFriendRequestsSerializer(serializers.ModelSerializer):
    ...
    """
    Serializer for retrieving incoming friend requests.
    """
...
class SentRequestsSerializer(serializers.ModelSerializer):
    ...
    """
    Serializer for retrieving sent friend requests.
    """
...
class GetUserFullData(serializers.ModelSerializer):
    ...
    """
    Serializer for retrieving full user data, including game stats, friend requests, friends, and sent requests.
    """
...
class GetUsersListSerializer(serializers.ModelSerializer):
	...
	"""
    Serializer for retrieving a list of users with their basic information, including game stats and total friends.
    """
